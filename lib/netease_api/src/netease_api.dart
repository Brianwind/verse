...
import 'package:verse/constants/platform.dart';
...
class UserLoginStateController {
  ...
  Future<void> init() async {
    ...
    _refreshLoginState(
      (await loadCookies()).isNotEmpty && _accountInfo != null
          ? LoginState.Logined
          : LoginState.Logout,
    );
  }
  ...
  void onLogined(NeteaseAccountInfoWrap infoWrap) {
    ...
    // print log here
    print('login success: ${infoWrap.toJson()}');
...
enum LoginState { Logined, Logout }
